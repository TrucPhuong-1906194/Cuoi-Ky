...
- **Lê Phan Trúc Phương**: `blog.html`, `contact.html`  
- **Nguyễn Hoàng Gia Hân**: `product.html`  
- **Nguyễn Bảo Lan**: `about.html`, các trang nhỏ của `blog.html`  
...
- [x] `product.html` – Product details (chi tiết 1 sản phẩm + ảnh, mô tả, giá…)  
- [x] `blog.html` – Blog shop (bài viết/tin tức liên quan shop)  
